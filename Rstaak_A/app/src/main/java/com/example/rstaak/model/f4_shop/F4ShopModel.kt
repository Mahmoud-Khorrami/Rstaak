...
@Parcelize
data class F4ShopModel @AssistedInject constructor(
    ...
    @Assisted("viewedNumber") var viewedNumber: Int): F4ShopParentModel(Main), Parcelable
{
        @AssistedFactory
        interface Factory
        {
            fun create(
                ...
                @Assisted("viewedNumber") viewedNumber: Int): F4ShopModel
        }
    }
