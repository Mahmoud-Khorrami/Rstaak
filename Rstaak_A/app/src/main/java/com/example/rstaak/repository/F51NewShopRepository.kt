...
class F51NewShopRepository @Inject constructor(
    var apiInterface: ApiInterface,
    var executor: ExecutorService)
{
    fun createNewShop(f51Request: F51Request): Future<Observable<F51Response>>
    {
        val callable = Callable { apiInterface.newShop(f51Request) }
    ...
    companion object
    {
        private const val TAG = "F51NewShopRepository"
    }
}